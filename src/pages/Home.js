...
const Home = () => {
  return (
    <>
      <section className="relative w-full h-[400px] rounded-xl overflow-hidden shadow-lg mb-12">
        {/* Imagem de fundo */}
        <img
        ...
        {/* Camada escura com z-index menor */}
       <div className="flex flex-col md:flex-row gap-4">
  <a
    href="https://wa.me/+5511994951277"
    target="_blank"
    rel="noopener noreferrer"
    className="bg-green-500 hover:bg-green-600 text-white px-6 py-3 rounded-full font-semibold shadow-lg transition flex items-center gap-2"
  >
    Fale no WhatsApp
  </a>
<br></br>
